        ...
        <Fragment>
          <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full bg-white">
            ...
            <div className="hidden lg:block">
              <span onClick={e=> history.push("/admin/dashboard")} style={{letterSpacing: '0.70rem'}} className="flex items-left text-center font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 text-center">E-Commerce</span>
            </div>
            {/* Small Screen Show */}
            <div className="lg:hidden flex items-center">
              ...
              <span onClick={e=> history.push("/admin/dashboard")} style={{letterSpacing: '0.10rem'}} className="flex items-left text-center font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 text-center">E-Commerce</span>
            </div>
            {/* Both Screen show */}
